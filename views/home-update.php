...
<?php 
        ...
        $sql = "SELECT T.CarRequestID
                ...
                WHERE T.NumberRequestID='$ct' ";
        $stmt = sqlsrv_query($db,$sql);
        $obj = sqlsrv_fetch_object( $stmt);
        
        $st = DateTime::createFromFormat("Y-m-d", $obj->FromDate); 
        $FromDate = $st->format("d/m/Y");
        $ed = DateTime::createFromFormat("Y-m-d", $obj->ToDate); 
        $ToDate = $ed->format("d/m/Y");
        $tt = DateTime::createFromFormat("H:i:s", $obj->FromTime); 
        $FromTime = $tt->format("H:i");
        $tto = DateTime::createFromFormat("H:i:s", $obj->ToTime); 
        $ToTime = $tto->format("H:i");
...
<div class="well col-lg-8">
    ...
    <form id="bookcar" class="form-horizontal" method="post" action="./updatereserve-car"  enctype="multipart/form-data">
    <label></label>
        <input type="hidden" name="id" value="<?php echo $obj->NumberRequestID; ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="tranfer_n" id="tranfer_n" placeholder="กรุณากรอก" onkeyup="myFunctionname()"  value="<?php echo $obj->UserAllow; ?>"/><span id="textalert"><font size="2">กรุณากรอก</font></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label" id="txttranfert">เบอร์โทร</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" name="tranfer_t" id="tranfer_t" placeholder="กรุณากรอก" onkeyup="myFunctiontel()" value="<?php echo $obj->UserAllowPhone; ?>"/><span id="textalertt"><font size="2">กรุณากรอก</font></span>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <select class="form-control" id="start" name="start" onclick="myFunctionStart()"  value="<?php echo $obj->NumberRequestID; ?>"/></select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="station" id="station" placeholder="กรุณากรอก" onkeyup="myFunctiontxtStart()" value="<?php echo $obj->StartingPoint; ?>"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="end" id="end" placeholder="กรุณากรอก" onkeyup="myFunctiontxtEnd()" value="<?php echo $obj->Finished; ?>"/>
        ...
        <div class="col-xs-4 dateContainer">
            <div class="input-group input-append date" id="startDatePicker" onclick="myFunctionclickStart()">
                <input type="text" class="form-control" name="startDate" id="startDate" value="<?php echo $FromDate; ?>"/>
            ...
            <div class="col-xs-2">
                <input type="text" class="form-control" name="startTime" id="startTime"  onkeyup="myFunctionclickStartDate()" onclick="myFunctionclickStartDate()" value="<?php echo $FromTime; ?>"/>
        ...
        <div class="col-xs-4 dateContainer">
            ...
            <div class="input-group input-append date">
                <input type="text" class="form-control" name="endDate" id="endDate" value="<?php echo $ToDate; ?>" readonly />
                <span class="input-group-addon add-on">
                <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
            ...
            <div class="col-xs-2">
                <input type="text" class="form-control" name="endTime" id="endTime" value="<?php echo $ToTime; ?>"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" name="people" id="people" placeholder="0" onclick="myFunctiontxtpeople()" onkeyup="myFunctiontxtpeople()" value="<?php echo $obj->Seat; ?>"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <textarea class="form-control" name="title" id="title" onkeyup="myFunctiontxttitle()"><?php echo $obj->Title; ?></textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input name="fileUpload" id="fileUpload" type="button" class="btn" value="+" ><br>
...
$(function () {
            var have = "<?php echo $obj->StartingPoint; ?>";
            var have_userallow = "<?php echo $obj->UserAllow; ?>";
            //var have_userallowP = "<?php echo $obj->UserAllowPhone; ?>";
            if (have) {
                $('#way').attr('checked', true);
                $('#txtstart').show();
                $('#station').show();
            }else{
                $('#way').attr('checked', false);
                $('#txtstart').hide();
                $('#station').hide();
            }
...
$('#bookcar').submit(function(e){
    ...
    .done(function(data){
      ...
      $.each(data, function( k, v ) {
        var filename = v.FileName;
              ...
              $('#linkmy').append("<button type='button' class='btn' onclick=deleteFile\('"+filename+"')>-</button><a target='_blank' href='upload/" + v.FileName + "'>" + v.FileName + "</a><br>");
              i++;
          }); 
    }); 
    ...
    $('#fileUpload').bind('click',function(){
           ...
           $('#mySpan').append("<button id='"+add+"' onclick='removeEle("+add+','+add1+','+br1+ ")' type='button' class='btn'>-</button><input type='file' name='fileUpload[]' id='"+add1+"'><br id='"+br1+"'>");
            num++;
