...
<div class="container">
	...
	<table>
		...
		<tr>
			...
			<td width="25%">
				<b>เวลารถออก</b> <?php echo substr($obj->StartTime,0,-3); ?>
			</td>
			<td width="25%">
			...
			<td width="25%">
				<b>เวลารถกลับ</b> <?php echo substr($obj->EndTime,0,-3); ?>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td colspan="6">
				<b>รายละเอียดการใช้รถ</b> <?php echo $obj->Remark; ?>
			</td>
		</tr>
		<?php 
